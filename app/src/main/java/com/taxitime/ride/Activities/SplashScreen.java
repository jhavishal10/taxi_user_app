...
import java.util.Map;
 ...
 public class SplashScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lblVersion = (TextView) findViewById(R.id.version);
        Log.v("VERSION NAME", ""+ BuildConfig.VERSION_NAME);
        Log.v("VERSION CODE", ""+BuildConfig.VERSION_CODE);
        lblVersion.setText(getResources().getString(R.string.version) +" "+ BuildConfig.VERSION_NAME);
...
//        getAccess();
        ...
        int oneMin=  1000; // 1 minute in milli seconds

        /** CountDownTimer starts with 1 minutes and every onTick is 1 second */
        CountDownTimer cdt = new CountDownTimer(oneMin, 1) {

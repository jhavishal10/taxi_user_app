...
import com.taxitime.ride.Helper.AppHelper;
...
import com.taxitime.ride.Helper.VolleyMultipartRequest;
...
//                Matcher lastName = ps.matcher(last_name.getText().toString());
    ...
    private void updateProfileWithImage() {
        ...
        UserApplication.getInstance().addToRequestQueue(volleyMultipartRequest);

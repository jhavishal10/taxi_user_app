 package com.taxitime.ride.Activities;
...
import com.taxitime.ride.FCM.ForceUpdateChecker;
import com.taxitime.ride.Fragments.Coupon;
import com.taxitime.ride.Fragments.Help;
import com.taxitime.ride.Fragments.HomeFragment;
import com.taxitime.ride.Fragments.Payment;
import com.taxitime.ride.Fragments.Wallet;
import com.taxitime.ride.Fragments.YourTrips;
import com.taxitime.ride.Helper.CustomDialog;
import com.taxitime.ride.Helper.LocaleUtils;
...
import com.taxitime.ride.Utils.CustomTypefaceSpan;
...
//        setSupportActionBar(toolbar);
    ...
    private Fragment getHomeFragment() {
        ...
        switch (navItemIndex) {
            ...
            case 1:
                // Payment fragment
                com.taxitime.ride.Fragments.Payment paymentFragment = new Payment();
...
//                .requestIdToken("795253286119-p5b084skjnl7sll3s24ha310iotin5k4.apps.googleusercontent.com")
    ...
    public void displayMessage(String toastString) {
        ...
        try {
            make(getCurrentFocus(), toastString, LENGTH_LONG)

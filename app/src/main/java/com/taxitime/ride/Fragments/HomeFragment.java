package com.taxitime.ride.Fragments;
...
import com.taxitime.ride.Activities.ActivityWallet;
import com.taxitime.ride.Activities.CouponActivity;
import com.taxitime.ride.Activities.CustomGooglePlacesSearch;
import com.taxitime.ride.Activities.HistoryActivity;
import com.taxitime.ride.Activities.ShowProfile;
import com.taxitime.ride.Activities.newlivechat;
import com.taxitime.ride.UserApplication;
import com.taxitime.ride.Helper.ConnectionHelper;
import com.taxitime.ride.Helper.CustomDialog;
import com.taxitime.ride.Helper.DataParser;
import com.taxitime.ride.Helper.SharedHelper;
import com.taxitime.ride.Helper.URLHelper;
import com.taxitime.ride.Models.CardInfo;
import com.taxitime.ride.Models.Driver;
import com.taxitime.ride.Models.PlacePredictions;
import com.taxitime.ride.R;
import com.taxitime.ride.Retrofit.ApiInterface;
import com.taxitime.ride.Retrofit.ResponseListener;
import com.taxitime.ride.Retrofit.RetrofitClient;
import com.taxitime.ride.Utils.MapAnimator;
import com.taxitime.ride.Utils.MyBoldTextView;
import com.taxitime.ride.Utils.MyButton;
import com.taxitime.ride.Utils.MyTextView;
import com.taxitime.ride.Utils.Utilities;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback, LocationListener,
    ...
    private String strPickLocation = "", strTag = "", strPickType = "";
    private boolean once = true;
    private int click = 1;
    private boolean afterToday = false;
    private boolean pick_first = true;
    private Driver driver;
    private ImageView daily, outstation;
    ...
    private LinearLayout sourceAndDestinationLayout, destinationLayer;
    private FrameLayout frmDestination;
    private MyBoldTextView destination;
...
//        <!--1. Driver Details-->
    ...
    MyBoldTextView lbDistanceCovered;
    MyBoldTextView lblTimeTakenPrice;
...
//         <!--2. Approximate Rate ...-->
    ...
    MyBoldTextView lblApproxAmount, surgeDiscount, surgeTxt ,lblapproxtoal, lblapproxtax, lblapproxdistance ;
    View lineView;
...
//         <!--4. Driver Accepted ...-->
    ...
    MyButton btnCall,btnsms, btnCancelTrip;
...
//        <!-- Map frame -->
        ...
        greetingtext = (TextView) activity.findViewById(R.id.greetingtext);

        String statuso = "Hello, ";
        if(Utilities.ismorning()){
            statuso = "Good Morning, ";
        }else if(Utilities.isafternoon()){
            statuso = "Good Afternoon, ";
        }else if(Utilities.isnight()){
            statuso = "Good Evening, ";
        }else{
            statuso = "Hello, ";
        }
        greetingtext.setText(statuso + SharedHelper.getKey(context, "first_name")+" "+SharedHelper.getKey(context, "last_name"));
...
//        <!-- Source and Destination Layout-->
      ...
      //  txtChange = (TextView) rootView.findViewById(R.id.txtChange);
        ...
        daily = (ImageView) rootView.findViewById(R.id.img_daily);
        outstation = (ImageView) rootView.findViewById(R.id.img_outstation);
...
//         <!--2. Approximate Rate ...-->
        ...
        addwallet = (TextView) rootView.findViewById(R.id.aWallet);
        layout_coupon = (LinearLayout) rootView.findViewById(R.id.layout_coupon);
        ...
        lblapproxtax = (MyBoldTextView) rootView.findViewById(R.id.lblapproxtax);
        lblapproxdistance = (MyBoldTextView) rootView.findViewById(R.id.lblapproxdistance);
        lblapproxtoal = (MyBoldTextView) rootView.findViewById(R.id.lblapproxtotal);
        ...
        addwallet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(getActivity(), ActivityWallet.class));
            }
        });
        ...
        daily.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                daily.setBackground(getResources().getDrawable(R.drawable.square_back));
                outstation.setBackground(null);
                isOutStation = false;
            }
        });
        outstation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                outstation.setBackground(getResources().getDrawable(R.drawable.square_back));
...
//          <!--4. Driver Accepted ...-->
        ...
        btnsms = (MyButton) rootView.findViewById(R.id.btnsms);
...
//           <!--5. Invoice Layout ...-->
        ...
        lbDistanceCovered = (MyBoldTextView) rootView.findViewById(R.id.lblDistanceCovered);

        lblTimeTaken = (MyBoldTextView) rootView.findViewById(R.id.lblTimeTaken);
        lblTimeTakenPrice = (MyBoldTextView) rootView.findViewById(R.id.lblTimeTakenprice);
...
//                            frmSource.setText(source_address);
    ...
    public void setValuesForApproximateLayout() {
        if (isInternet) {
            ...
            lblapproxtoal.setText(SharedHelper.getKey(context, "currency") + "" + SharedHelper.getKey(context, "eta_total"));
                    ...
                    try {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            ...
                            try {
                                ...
                                if(isOutStation){
                                    if(obj.getString("type").equals("daily"))
                                    {
...
//                            }
    ...
    public void sendRequest() {
        ...
        try {
            ...
            object.put("testamount", SharedHelper.getKey(context, "eta_total"));
...
//                    mMap.animateCamera(cu);
    ...
    private class ServiceListAdapter extends RecyclerView.Adapter<ServiceListAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.serviceprice.setText(SharedHelper.getKey(context, "currency") +" "+ jsonArray.optJSONObject(position).optString("price")+"/KM");
            ...
            if (position == currentPostion) {
                ...
                holder.serviceCapacityTv.setTextColor(ContextCompat.getColor(context, R.color.text_color_white));
                holder.serviceCapacityItemIv.setBackground(context.getResources().getDrawable(R.drawable.ic_person_white));
                ...
                holder.serviceCapacityTv.setTextColor(ContextCompat.getColor(context, R.color.black_text_color));
                holder.serviceCapacityItemIv.setBackground(context.getResources().getDrawable(R.drawable.ic_person_black));
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            MyTextView serviceTitle,serviceprice, serviceCapacityTv;
            ...
            public MyViewHolder(View itemView) {
                ...
                serviceprice = (MyTextView) itemView.findViewById(R.id.serviceprice);

package com.taxitime.ride.Helper;
...
public class URLHelper {
    ...
    // without https
     public static final int client_id = 6;  // server side passport credentials
     public static final String client_secret = "9eja2rfJrVUgO1ofNlmfjeYKzxU6abKE8zAmlQLI";

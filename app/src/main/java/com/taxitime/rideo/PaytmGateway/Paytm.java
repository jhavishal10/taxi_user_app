package com.taxitime.rideo.PaytmGateway;
...
public class Paytm {
    ...
    public Paytm(String s, String id, String mId, String channelId, String txnAmount, String website, String callBackUrl, String industryTypeId) {
        this.mId = mId;
